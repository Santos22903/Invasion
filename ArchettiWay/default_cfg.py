...
cost       = 0.000001# cost of producing benefits; initial=0.1 taken as mid of fig 2 range
useCost    = True # whether to account for cost of PG production
...
update_type= "deterministic" # deterministic or stochastic
findContrib= "direct"          # "wrap" or "direct"
