...
def bindingStep(local_rng, benefarray, gfcoords, cellarray, useMultiproc=True, useMap=True):
    ...
    print("Process: ", mp.current_process()," resarray ",resarray)
...
def GillespieFn(local_rng,benefBound,benefFree,cell):#,rand0,rand1):
    ...
    print("Process: ", mp.current_process()," local_rng ",local_rng," benefBound ",benefBound," benefFree ",benefFree," cel ",cell)
