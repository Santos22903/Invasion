...
def GillespieFn_multi(benefBound,benefFree,local_seed):
    """
...
def GillespieFn_1react(benefBound,benefFree,rand0,rand1):
    """
...
def doStepping(benefarray,
    ...
    for stepN in range(Nsteps_max):
        ...
        #print(stepN)
        (benefarray, gfcoords) = bindingStep(benefarray, gfcoords,
...
def printGlobalVars():
    ...
    print("bind_1reaction ",bind_1reaction," useMultiproc ",useMultiprocConstant," useMap ",useMapConstant)
