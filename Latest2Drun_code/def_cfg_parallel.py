...
#inflx=0.5
#steep=0.1
n_cycles=25 # number of cell proliferation cycles to run for: changed 10->25, 09/20/22 (5 for debugging)
L=15      # linear dimension of square lattice - initial value in "expanding", +1 each cycle
L_filled=15 # initially filled part at center of lattice - initial value in "expanding", +1 each cycle
...
#
n_runs    = 10        # how many independent runs to perform
