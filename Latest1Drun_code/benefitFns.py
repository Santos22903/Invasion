...
def hillFn(n_bound, EC50_bound=10, n=1, offset=0):
    """
    INPUT
    ...
    n    hill coefficient
    offset - added on 11/18/22 for comparison w Mike - add to all benefits to avoid 0's
    ...
    ## calculating benefit
    benefit = 1/(1+pow(ratio,n)) + offset
